...
namespace EnrollementApplication.Models
{
    public class EnrollementDBContext : DbContext
    {
        ...
        public EnrollementDBContext() : base("name=EnrollementDBContext")
        {
        }

        public System.Data.Entity.DbSet<EnrollementApplication.Models.Enrollement> Enrollements { get; set; }
